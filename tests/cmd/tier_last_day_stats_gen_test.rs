...
pub const SOURCE_FILE: &str = "cmd/tier-last-day-stats_gen_test.go";

use minio_rust::cmd::{DailyAllTierStats, LastDayTierStats};
...
impl_cmd_codec!(DailyAllTierStats);
impl_cmd_codec!(LastDayTierStats);
...
codec_tests!(daily_all_tier_stats, DailyAllTierStats);
codec_tests!(last_day_tier_stats, LastDayTierStats);
