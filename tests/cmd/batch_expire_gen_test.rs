...
pub const SOURCE_FILE: &str = "cmd/batch-expire_gen_test.go";

use minio_rust::cmd::{BatchJobExpire, BatchJobExpireFilter, BatchJobExpirePurge};
...
impl_cmd_codec!(BatchJobExpire);
impl_cmd_codec!(BatchJobExpireFilter);
impl_cmd_codec!(BatchJobExpirePurge);
...
codec_tests!(batch_job_expire, BatchJobExpire);
codec_tests!(batch_job_expire_filter, BatchJobExpireFilter);
codec_tests!(batch_job_expire_purge, BatchJobExpirePurge);
