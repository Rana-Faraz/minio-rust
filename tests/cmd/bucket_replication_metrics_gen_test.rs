...
use minio_rust::cmd::{
    ActiveWorkerStat, InQueueMetric, InQueueStats, ProxyMetric, QStat, ReplicationMRFStats,
    XferStats, SMA,
};

pub const SOURCE_FILE: &str = "cmd/bucket-replication-metrics_gen_test.go";
...
impl_cmd_codec!(ActiveWorkerStat);
impl_cmd_codec!(InQueueMetric);
impl_cmd_codec!(InQueueStats);
impl_cmd_codec!(ProxyMetric);
impl_cmd_codec!(QStat);
impl_cmd_codec!(ReplicationMRFStats);
impl_cmd_codec!(SMA);
impl_cmd_codec!(XferStats);
...
codec_tests!(active_worker_stat, ActiveWorkerStat);
codec_tests!(in_queue_metric, InQueueMetric);
codec_tests!(in_queue_stats, InQueueStats);
codec_tests!(proxy_metric, ProxyMetric);
codec_tests!(q_stat, QStat);
codec_tests!(replication_mrf_stats, ReplicationMRFStats);
codec_tests!(sma, SMA);
codec_tests!(xfer_stats, XferStats);
