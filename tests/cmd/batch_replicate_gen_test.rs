...
use minio_rust::cmd::{
    BatchJobReplicateCredentials, BatchJobReplicateFlags, BatchJobReplicateSource,
    BatchJobReplicateTarget, BatchJobReplicateV1, BatchReplicateFilter,
};

pub const SOURCE_FILE: &str = "cmd/batch-replicate_gen_test.go";
...
impl_cmd_codec!(BatchJobReplicateCredentials);
impl_cmd_codec!(BatchJobReplicateFlags);
impl_cmd_codec!(BatchJobReplicateSource);
impl_cmd_codec!(BatchJobReplicateTarget);
impl_cmd_codec!(BatchJobReplicateV1);
impl_cmd_codec!(BatchReplicateFilter);
...
codec_tests!(
    batch_job_replicate_credentials,
    BatchJobReplicateCredentials
);
codec_tests!(batch_job_replicate_flags, BatchJobReplicateFlags);
codec_tests!(batch_job_replicate_source, BatchJobReplicateSource);
codec_tests!(batch_job_replicate_target, BatchJobReplicateTarget);
codec_tests!(batch_job_replicate_v1, BatchJobReplicateV1);
codec_tests!(batch_replicate_filter, BatchReplicateFilter);
