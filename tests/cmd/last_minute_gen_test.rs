...
pub const SOURCE_FILE: &str = "cmd/last-minute_gen_test.go";

use minio_rust::cmd::{AccElem, LastMinuteHistogram, LastMinuteLatency};
...
impl_cmd_codec!(AccElem);
impl_cmd_codec!(LastMinuteHistogram);
impl_cmd_codec!(LastMinuteLatency);
...
codec_tests!(acc_elem, AccElem);
codec_tests!(last_minute_histogram, LastMinuteHistogram);
codec_tests!(last_minute_latency, LastMinuteLatency);
