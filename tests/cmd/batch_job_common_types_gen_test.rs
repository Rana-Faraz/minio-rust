...
use minio_rust::cmd::{
    BatchJobKV, BatchJobNotification, BatchJobRetry, BatchJobSizeFilter, BatchJobSnowball,
};

pub const SOURCE_FILE: &str = "cmd/batch-job-common-types_gen_test.go";
...
impl_cmd_codec!(BatchJobKV);
impl_cmd_codec!(BatchJobNotification);
impl_cmd_codec!(BatchJobRetry);
impl_cmd_codec!(BatchJobSizeFilter);
impl_cmd_codec!(BatchJobSnowball);
...
codec_tests!(batch_job_kv, BatchJobKV);
codec_tests!(batch_job_notification, BatchJobNotification);
codec_tests!(batch_job_retry, BatchJobRetry);
codec_tests!(batch_job_size_filter, BatchJobSizeFilter);
codec_tests!(batch_job_snowball, BatchJobSnowball);
