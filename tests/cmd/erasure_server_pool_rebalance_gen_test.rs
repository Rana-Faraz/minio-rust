...
use minio_rust::cmd::{RebalanceInfo, RebalanceMeta, RebalanceMetrics, RebalanceStats, Rstats};

pub const SOURCE_FILE: &str = "cmd/erasure-server-pool-rebalance_gen_test.go";
...
impl_cmd_codec!(RebalanceInfo);
impl_cmd_codec!(RebalanceMeta);
impl_cmd_codec!(RebalanceMetrics);
impl_cmd_codec!(RebalanceStats);
impl_cmd_codec!(Rstats);
...
codec_tests!(rebalance_info, RebalanceInfo);
codec_tests!(rebalance_meta, RebalanceMeta);
codec_tests!(rebalance_metrics, RebalanceMetrics);
codec_tests!(rebalance_stats, RebalanceStats);
codec_tests!(rstats, Rstats);
